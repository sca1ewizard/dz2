...
{	
	...
	int sum = 1;  	            // сумма используется в алгоритме по определению матрицы
...
Программе следует передать матрицу инцидентности графа и она посчитает, связанный он или нет.

Матрицу можно вводить через пробел, либо без него.
